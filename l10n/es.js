OC.L10N.register(
    "files_clipboard",
    {
    "Could not remove '%s'" : "No se ha podido eliminar '%s'",
    "Could not move '%s'" : "No se ha podido mover '%s'",
    "Could not copy '%s'" : "No se ha podido copiar '%s'",
    "Cut" : "Cortar",
    "Copy" : "Copiar",
    "Paste" : "Pegar",
    "Unable to paste: the files come from this directory." : "No se ha podido pegar: los archivos vienen de esta carpeta.",
